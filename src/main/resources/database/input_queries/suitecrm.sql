...
SELECT oauth_consumer.* FROM oauth_consumer  WHERE c_key = '' AND deleted='0'LIMIT 1
...
SELECT account_id FROM accounts_contacts WHERE contact_id='2' LIMIT 1
...
SELECT tasks.* FROM tasks  WHERE tasks.id = '8e5f042a-01a2-b1ab-53df-589c856d05a2' AND tasks.deleted='0'LIMIT 1
...
SELECT calls.* FROM calls  WHERE calls.id = 'c94a263b-747b-d4f1-f2f5-589c85af76fe' AND calls.deleted='0'LIMIT 1
SELECT eapm.* FROM eapm  WHERE eapm.id = 'adf4ad9c-6e3a-2ab1-a0fe-589c85e35558' AND eapm.deleted='0'LIMIT 1
...
SELECT cases.*,cases_cstm.* FROM cases  LEFT JOIN cases_cstm ON cases.id = cases_cstm.id_c  WHERE cases.id = '610b3ee0-80df-4b8f-54d1-589c8545f8c6' AND cases.deleted='0'LIMIT 1
SELECT aos_contracts.* FROM aos_contracts  WHERE aos_contracts.id = 'b5053637-72bf-2991-1f1f-589c85d9d496' AND aos_contracts.deleted='0'LIMIT 1
SELECT id FROM securitygroups_records WHERE record_id = '1' AND module = 'Calls' AND securitygroup_id = '1' AND deleted='0'LIMIT 1
...
SELECT aop_case_updates.* FROM aop_case_updates  WHERE aop_case_updates.id = 'c48c392a-a6f9-8a1c-5e13-589c85e693dc' AND aop_case_updates.deleted='0'LIMIT 1
SELECT id FROM users WHERE deleted='0'AND is_group='0'AND portal_only='0'
SELECT documents.* FROM documents  WHERE documents.id = '' AND documents.deleted='0'LIMIT 1
...
SELECT aos_product_categories.* FROM aos_product_categories  WHERE aos_product_categories.id = '1' AND aos_product_categories.deleted='0'LIMIT 1
...
SELECT notes.* FROM notes  WHERE notes.id = '2ca107b1-7e57-2768-b563-589c8376f3f4' AND notes.deleted='0'LIMIT 1
...
SELECT leads.*,leads_cstm.* FROM leads  LEFT JOIN leads_cstm ON leads.id = leads_cstm.id_c  WHERE leads.id = 'ca56e9f8-ae3b-ab0d-5326-589c8518ddab' AND leads.deleted='0'LIMIT 1
...
SELECT first_name, last_name, assigned_user_id contact_name_owner FROM contacts WHERE id='1' LIMIT 1
...
SELECT id FROM favorites WHERE parent_id= '1' AND parent_type = 'Accounts' AND assigned_user_id = '' AND deleted ='0'ORDER BY date_entered DESC LIMIT 1
...
SELECT eapm.* FROM eapm  WHERE assigned_user_id = '' AND application = '' AND deleted = '0' AND validated = '1' AND deleted='0'LIMIT 1
...
SELECT aor_reports.* FROM aor_reports  WHERE aor_reports.id = '22761e76-c3df-05f1-f67d-589c854aac22' AND aor_reports.deleted='0'LIMIT 1
...
SELECT aod_index.* FROM aod_index  WHERE aod_index.id = '1' AND aod_index.deleted='0'LIMIT 1
...
SELECT * from users where user_name='test' LIMIT 1
SELECT aor_conditions.* FROM aor_conditions  WHERE aor_conditions.id = '389d0165-5d89-69c3-cdee-589c85f0401c' AND aor_conditions.deleted='0'LIMIT 1
SELECT accounts.*,accounts_cstm.* FROM accounts  LEFT JOIN accounts_cstm ON accounts.id = accounts_cstm.id_c  WHERE accounts.id = '1' AND accounts.deleted='0'LIMIT 1
SELECT eapm.* FROM eapm  WHERE assigned_user_id = '' AND application = '' AND deleted = '0' AND deleted='0'LIMIT 1
SELECT id FROM aow_conditions WHERE aow_workflow_id = '' AND deleted ='0'ORDER BY condition_order ASC
SELECT meetings.*, meetings_cstm.* FROM meetings LEFT JOIN meetings_cstm ON meetings.id = meetings_cstm.id_c  WHERE meetings.deleted ='0'AND meetings.id = '1' LIMIT 1
...
SELECT aor_charts.* FROM aor_charts  WHERE aor_charts.id = '353ca905-49b5-ed0a-b6b6-589c85fc8d6e' AND aor_charts.deleted='0'LIMIT 1
select email_address_id from email_addr_bean_rel where bean_id = '' and email_addr_bean_rel.primary_address='1'and deleted='0'
SELECT aor_scheduled_reports.* FROM aor_scheduled_reports  WHERE aor_scheduled_reports.id = '9df9f4e0-9555-4dfd-a09c-589c8597d4ae' AND aor_scheduled_reports.deleted='0'LIMIT 1
...
SELECT bugs.* FROM bugs  WHERE bugs.id = '58800532-0e9d-ccaf-e85e-589c85722403' AND bugs.deleted='0'LIMIT 1
...
SELECT accounts.*, accounts_cstm.* FROM accounts LEFT JOIN accounts_cstm ON accounts.id = accounts_cstm.id_c  LEFT JOIN accounts_opportunities ON accounts.id = accounts_opportunities.account_id AND accounts_opportunities.deleted ='0' WHERE accounts.deleted ='0'AND accounts_opportunities.opportunity_id = '' LIMIT 1
SELECT aos_invoices.* FROM aos_invoices  WHERE aos_invoices.id = '1' AND aos_invoices.deleted='0'LIMIT 1
...
SELECT email_addresses.* FROM email_addresses  WHERE email_addresses.id = 'b10d3d59-ab27-3b26-13ee-589c84de0d8e' AND email_addresses.deleted='0'LIMIT 1
...
SELECT prospect_lists.* FROM prospect_lists  WHERE prospect_lists.id = '1a06a34d-9a05-c9dc-5a8b-589c85760304' AND prospect_lists.deleted='0'LIMIT 1
...
SELECT contacts.*,contacts_cstm.* FROM contacts  LEFT JOIN contacts_cstm ON contacts.id = contacts_cstm.id_c  WHERE contacts.id = 'test id' AND contacts.deleted='0'LIMIT 1
...
SELECT accounts.*, accounts_cstm.* FROM accounts LEFT JOIN accounts_cstm ON accounts.id = accounts_cstm.id_c  WHERE accounts.deleted ='0'AND id = '' LIMIT 1
SELECT count(*) as the_count FROM config WHERE category='info' AND name='sugar_version' AND value = ''
SELECT aos_products.* FROM aos_products  WHERE aos_products.id = '35088225-e323-0a98-4eaf-589c857e1471' AND aos_products.deleted='0'LIMIT 1
...
SELECT currencies.* FROM currencies  WHERE currencies.id = '1edd9b52-818e-d5a4-78be-589c851d5d65' AND currencies.deleted='0'LIMIT 1
SELECT email_marketing.* FROM email_marketing  WHERE email_marketing.id = '' AND email_marketing.deleted='0'LIMIT 1
...
SELECT id FROM notes where parent_id='1' AND parent_type='Emails' AND file_mime_type is not null AND deleted='0'LIMIT 1
...
SELECT aos_products_quotes.* FROM aos_products_quotes  WHERE aos_products_quotes.id = '56f6e3a8-e6b3-eff2-7f47-589c855dd7a8' AND aos_products_quotes.deleted='0'LIMIT 1
...
SELECT campaign_trkrs.* FROM campaign_trkrs  WHERE campaign_trkrs.id = 'ecb15ceb-e4e0-f26f-fe9e-589c859f63b1' AND campaign_trkrs.deleted='0'LIMIT 1
...
SELECT aow_workflow.* FROM aow_workflow  WHERE aow_workflow.id = '1' AND aow_workflow.deleted='0'LIMIT 1
...
SELECT sugarfeed.* FROM sugarfeed  WHERE related_id = '1' AND related_module = 'SugarFeed' AND deleted='0'LIMIT 1
...
SELECT email_templates.* FROM email_templates  WHERE email_templates.id = '1' AND email_templates.deleted='0'LIMIT 1
...
SELECT users.* FROM users  WHERE user_name = '1' AND deleted='0'LIMIT 1
SELECT name , assigned_user_id account_name_owner FROM accounts WHERE id='1' LIMIT 1
...
SELECT aow_processed.* FROM aow_processed  WHERE aow_processed.id = 'd7abea92-7cf3-ca25-d70d-589c8552ead4' AND aow_processed.deleted='0'LIMIT 1
...
SELECT inbound_email.* FROM inbound_email  WHERE group_id = '' AND deleted='0'LIMIT 1
SELECT project_task.* FROM project_task  WHERE project_task.id = 'b73ad8f7-7e94-2e67-2afc-589c85f52879' AND project_task.deleted='0'LIMIT 1
...
SELECT id FROM aor_fields WHERE aor_report_id = '' AND group_display ='1'AND deleted ='0'ORDER BY field_order ASC LIMIT 1
SELECT id FROM notes WHERE notes.created_by = '' AND notes.deleted='0'
SELECT job_queue.* FROM job_queue  WHERE job_queue.id = '66c88bff-987b-ad1c-5f53-589c8507856c' AND job_queue.deleted='0'LIMIT 1
SELECT * FROM roles_users WHERE deleted = '0'   AND user_id = '2'  AND role_id = '1'
SELECT users.* FROM users  WHERE users.id = 'cec00d21-5ea1-f407-be72-589c7d71586a' AND users.deleted='0'LIMIT 1
...
SELECT meetings.*,meetings_cstm.* FROM meetings  LEFT JOIN meetings_cstm ON meetings.id = meetings_cstm.id_c  WHERE meetings.id = 'cce0654f-a2d9-da15-68a8-589c8458adac' AND meetings.deleted='0'LIMIT 1
SELECT first_name, last_name FROM contacts WHERE id='1' AND deleted='0'LIMIT 1
SELECT opportunities.*, opportunities_cstm.* FROM opportunities LEFT JOIN opportunities_cstm ON opportunities.id = opportunities_cstm.id_c  LEFT JOIN projects_opportunities ON opportunities.id = projects_opportunities.opportunity_id AND projects_opportunities.deleted ='0' WHERE opportunities.deleted ='0'AND projects_opportunities.project_id = '1' LIMIT 1
...
SELECT COUNT(*) AS ncount FROM campaign_log WHERE campaign_id = '' AND target_id IS NULL AND activity_type = 'lead' LIMIT 1
...
SELECT distinct item_id AS item_id, id, item_summary, module_name, monitor_id, date_modified FROM tracker WHERE user_id = '1' AND deleted ='0'AND visible ='1' ORDER BY date_modified DESC LIMIT 50
...
SELECT id FROM users WHERE id = '1' AND is_admin ='1'AND deleted ='0'AND status = 'Active' LIMIT 1
...
SELECT aos_line_item_groups.* FROM aos_line_item_groups  WHERE aos_line_item_groups.id = '1228c4a9-614c-31e7-7542-589c85451f14' AND aos_line_item_groups.deleted='0'LIMIT 1
...
SELECT document_revisions.* FROM document_revisions  WHERE document_revisions.id = '3c9f3299-3069-8feb-4a9c-589c85a22713' AND document_revisions.deleted='0'LIMIT 1
...
SELECT accounts.*, accounts_cstm.* FROM accounts LEFT JOIN accounts_cstm ON accounts.id = accounts_cstm.id_c  LEFT JOIN projects_accounts ON accounts.id = projects_accounts.account_id AND projects_accounts.deleted ='0' WHERE accounts.deleted ='0'AND projects_accounts.project_id = '1' LIMIT 1
...
SELECT user_preferences.* FROM user_preferences  WHERE assigned_user_id = '1' AND category = 'home' AND deleted='0'LIMIT 1
...
SELECT accounts.*, accounts_cstm.* FROM accounts LEFT JOIN accounts_cstm ON accounts.id = accounts_cstm.id_c  LEFT JOIN accounts_cases ON accounts.id = accounts_cases.account_id AND accounts_cases.deleted ='0' WHERE accounts.deleted ='0'AND accounts_cases.case_id = '1' LIMIT 1
...
SELECT users.* FROM users  WHERE users.id = '42494856-4357-0ff9-d7a8-58974c4b55f8' AND users.deleted='0'LIMIT 1
...
SELECT accounts.*, accounts_cstm.* FROM accounts LEFT JOIN accounts_cstm  ON accounts.id = accounts_cstm.id_c  WHERE accounts.deleted ='0'AND (accounts_cstm.jjwg_maps_lat_c ='0'AND accounts_cstm.jjwg_maps_lng_c ='0' OR (accounts_cstm.jjwg_maps_lat_c IS NULL AND accounts_cstm.jjwg_maps_lng_c IS NULL)) AND (accounts_cstm.jjwg_maps_geocode_status_c = '' OR accounts_cstm.jjwg_maps_geocode_status_c IS NULL) LIMIT 250
SELECT emails.* FROM emails  WHERE emails.id = 'b3cd04d9-5080-4707-0979-589c859a71d7' AND emails.deleted='0'LIMIT 1
...
SELECT aor_fields.* FROM aor_fields  WHERE aor_fields.id = '2ef079b5-3a34-0c5b-f390-589c855efae6' AND aor_fields.deleted='0'LIMIT 1
...
SELECT name, assigned_user_id opportunity_name_owner FROM opportunities WHERE id='1' LIMIT 1
SELECT email_templates.id, name as display from email_templates where  email_templates.deleted='0'
SELECT aop_case_events.* FROM aop_case_events  WHERE aop_case_events.id = '671d1ad2-0d3d-f611-27df-589c8502ff44' AND aop_case_events.deleted='0'LIMIT 1
...
SELECT jjwg_address_cache.* FROM jjwg_address_cache WHERE jjwg_address_cache.deleted ='0'AND jjwg_address_cache.name='test' LIMIT 1
SELECT emails.* FROM emails  WHERE emails.id = '0' LIMIT 1
SELECT id FROM cron_remove_documents WHERE module='' AND bean_id='' LIMIT 1
...
SELECT oauth_tokens.* FROM oauth_tokens  WHERE oauth_tokens.id = '15e4eabf13e5' AND oauth_tokens.deleted='0'LIMIT 1
SELECT id, first_name, last_name, user_name FROM users WHERE 1='1'ORDER BY  user_name ASC
SELECT aos_quotes.* FROM aos_quotes  WHERE aos_quotes.id = '1' AND aos_quotes.deleted='0'LIMIT 1
...
SELECT vcals.* FROM vcals  WHERE user_id = '1' AND type = 'vfb' AND source = 'sugar' AND deleted='0'LIMIT 1
...
SELECT vcals.* FROM vcals  WHERE vcals.id = '46e004b7-ac49-a870-1a0f-589c81f8df4a' AND vcals.deleted='0'LIMIT 1
...
SELECT id FROM securitygroups_users WHERE user_id = '1' AND securitygroup_id = '1' AND deleted='0'LIMIT 1
...
SELECT aow_processed.* FROM aow_processed  WHERE aow_workflow_id = '' AND parent_id = '' AND deleted='0'LIMIT 1
...
SELECT acl_roles.* FROM acl_roles  WHERE acl_roles.id = '1' AND acl_roles.deleted='0'LIMIT 1
