...
select name from "tabcustomer" where tabcustomer.status = 'Open' order by tabcustomer.modified desc limit 100
...
select name from "tabWarranty Claim" where "tabWarranty Claim".status = 'Open' order by "tabWarranty Claim".modified DESC limit 100
...
select name from "tabquotation" where tabquotation.customer = '_Test Customer 1' and ifnull(tabquotation.docstatus, 0) = 0.0 order by tabquotation.docstatus asc, tabquotation.modified DESC limit 1
...
select name from "tabError Snapshot" where "tabError Snapshot".seen = 0.0 and "tabError Snapshot".parent_error_snapshot ='0'order by "tabError Snapshot".timestamp DESC limit 100
...
select name from "tablead" where tablead.status = 'Open' order by tablead.modified DESC limit 100
...
select name from "tabtimesheet" where tabtimesheet.status = 'Draft' order by tabtimesheet.docstatus asc, tabtimesheet.modified desc limit 100
...
select name from "tabStock Entry" where "tabStock Entry".docstatus = 0.0 order by "tabStock Entry".docstatus asc, "tabStock Entry".modified DESC limit 100
...
select name from "tabissue" where tabissue.status = 'Open' order by tabissue.modified desc limit 100
...
select name from "tabSupplier Quotation" where "tabSupplier Quotation".docstatus = 0.0 order by "tabSupplier Quotation".docstatus asc, "tabSupplier Quotation".modified DESC limit 100
...
select name from "tabEmail Queue" order by creation desc limit 1
...
select name, route from "tabBlog Post" where ifnull("tabBlog Post".route, '') != '' and "tabBlog Post".published = 1.0 order by "tabBlog Post".modified desc limit 1
...
select name from "tabPayment Entry" where "tabPayment Entry".docstatus = 0.0 order by "tabPayment Entry".docstatus asc, "tabPayment Entry".modified DESC limit 100
...
select name from "tabquotation" where tabquotation.customer = '_Test Customer' and ifnull(tabquotation.docstatus, 0) = 0.0 and tabquotation.order_type = 'Shopping Cart' order by modified desc limit 1
...
select name, route from "tabBlog Post" where "tabBlog Post".published = 0.0 order by "tabBlog Post".modified desc limit 1
...
select name from "tabaccount" order by RAND() limit 1
...
select distinct * from "tabevent" where tabevent.owner = 'Administrator' order by tabevent.modified desc limit 20
...
select name from "tabPurchase Receipt" where ifnull("tabPurchase Receipt".status, '') not in ('Completed', 'Closed') and ifnull("tabPurchase Receipt".docstatus, 0) < 2.0 and "tabPurchase Receipt".supplier = '_Test Supplier' order by "tabPurchase Receipt".docstatus asc, "tabPurchase Receipt".modified DESC limit 1
...
select name from "tabsupplier" where tabsupplier.status = 'Open' order by tabsupplier.modified desc limit 100
...
select name from "tabopportunity" where tabopportunity.status = 'Open' and tabopportunity.customer = '_Test Lead' order by tabopportunity.modified DESC limit 1
...
select name from "tabPurchase Invoice" where "tabPurchase Invoice".docstatus < 2.0 and "tabPurchase Invoice".outstanding_amount > 0.0 order by "tabPurchase Invoice".docstatus asc, "tabPurchase Invoice".modified DESC limit 100
...
select name from "tabSupplier Quotation" where "tabSupplier Quotation".supplier = '_Test Supplier' and ifnull("tabSupplier Quotation".docstatus, 0) = 0.0 order by "tabSupplier Quotation".docstatus asc, "tabSupplier Quotation".modified DESC limit 1
...
select name from "tabtask" where tabtask.status = 'Overdue' order by tabtask.modified desc limit 100
...
select "tabCustom DocPerm".role, "tabCustom DocPerm".permlevel, "tabCustom DocPerm".read, "tabCustom DocPerm".write, "tabCustom DocPerm".submit, "tabCustom DocPerm".cancel, "tabCustom DocPerm".name, "tabCustom DocPerm".modified, "tabCustom DocPerm".docstatus from "tabCustom DocPerm" where "tabCustom DocPerm".role = 'System Manager' order by "tabCustom DocPerm".modified ASC
...
select name from "tabSales Invoice" where "tabSales Invoice".docstatus < 2.0 and "tabSales Invoice".outstanding_amount > 0.0 order by "tabSales Invoice".docstatus asc, "tabSales Invoice".modified DESC limit 100
...
select name from "tabseries" where name= '_T-Production Order-'
...
select name from "tabcommunication" where tabcommunication.status = 'Open' and tabcommunication.communication_type = 'Communication' order by tabcommunication.modified desc limit 100
...
select name from "tabProduction Order" where "tabProduction Order".status in ('Draft', 'Not Started', 'In Process') order by "tabProduction Order".docstatus asc, "tabProduction Order".modified desc limit 100
...
select name from "tabMaterial Request" where "tabMaterial Request".status not in ('Stopped') and "tabMaterial Request".docstatus < 2.0 and "tabMaterial Request".per_ordered < 100.0 order by "tabMaterial Request".docstatus asc, "tabMaterial Request".modified DESC limit 100
...
select name from "tabSales Order" where "tabSales Order".status not in ('Completed', 'Closed') and "tabSales Order".docstatus < 2.0 order by "tabSales Order".docstatus asc, "tabSales Order".modified DESC limit 100
select name from "tabPurchase Invoice" where "tabPurchase Invoice".supplier = '_Test Supplier 1' and ifnull("tabPurchase Invoice".docstatus, 0) < 2.0 and "tabPurchase Invoice".outstanding_amount > 0.0 order by "tabPurchase Invoice".docstatus asc, "tabPurchase Invoice".modified DESC limit 1
...
select name from "tabPurchase Order" where ifnull("tabPurchase Order".status, '') not in ('Completed', 'Closed') and ifnull("tabPurchase Order".docstatus, 0) < 2.0 and "tabPurchase Order".supplier = '_Test Supplier with Country' order by "tabPurchase Order".docstatus asc, "tabPurchase Order".modified DESC limit 1
...
select name from "tabDelivery Note" where ifnull("tabDelivery Note".status, '') not in ('Completed', 'Closed') and ifnull("tabDelivery Note".docstatus, 0) < 2.0 and "tabDelivery Note".customer = '_Test Customer 3' order by "tabDelivery Note".docstatus asc, "tabDelivery Note".modified DESC limit 1
...
select name from "tabissue" where tabissue.status = 'Open' and tabissue.customer = '_Test Customer 3' order by tabissue.modified desc limit 1
select name from "tabError Log" where "tabError Log".seen = 0.0 order by "tabError Log".modified desc limit 100
...
select name from "tabLeave Application" where "tabLeave Application".status = 'Open' order by "tabLeave Application".docstatus asc, "tabLeave Application".modified DESC limit 100
...
select name from "tabExpense Claim" where "tabExpense Claim".approval_status = 'Draft' order by "tabExpense Claim".docstatus asc, "tabExpense Claim".modified DESC limit 100
...
select name from "tabJournal Entry" where "tabJournal Entry".docstatus = 0.0 order by "tabJournal Entry".docstatus asc, "tabJournal Entry".modified DESC limit 100
...
select name from "tabitem" where tabitem.total_projected_qty < 0.0 order by tabitem.idx desc, tabitem.modified desc limit 100
...
select name from "tabproject" where tabproject.status = 'Open' and tabproject.customer = '_Test Customer USD' order by tabproject.modified desc limit 1
...
select name from "tabDelivery Note" where "tabDelivery Note".status not in ('Completed', 'Closed') and "tabDelivery Note".docstatus < 2.0 order by "tabDelivery Note".docstatus asc, "tabDelivery Note".modified DESC limit 100
...
select *, timestamp(posting_date, posting_time) as "timestamp" from "tabStock Ledger Entry" where item_code = '_Test Item Home Desktop 100' and warehouse = '_Test Warehouse 1 - _TC' and ifnull(is_cancelled, 'No')='No' and timestamp(posting_date, posting_time) > timestamp('2013-03-01', '00:00') and name!='SLE/00000083' order by timestamp(posting_date, posting_time) asc, name asc
...
select name from "tabopportunity" where tabopportunity.status = 'Open' order by tabopportunity.modified DESC limit 100
...
select name from "tabtodo" order by creation desc limit 1
...
select name from "tabquotation" where tabquotation.docstatus = 0.0 order by tabquotation.docstatus asc, tabquotation.modified DESC limit 100
...
select name from "tabPurchase Receipt" where "tabPurchase Receipt".status not in ('Completed', 'Closed') and "tabPurchase Receipt".docstatus < 2.0 order by "tabPurchase Receipt".docstatus asc, "tabPurchase Receipt".modified DESC limit 100
...
select name from "tabbom" where tabbom.docstatus = 0.0 order by tabbom.docstatus asc, tabbom.modified DESC limit 100
...
select name from "tabproject" where tabproject.status = 'Open' order by tabproject.modified desc limit 100
...
select name from "tabSales Invoice" where "tabSales Invoice".customer = 'Party Status Test' and ifnull("tabSales Invoice".docstatus, 0) < 2.0 and "tabSales Invoice".outstanding_amount > 0.0 order by "tabSales Invoice".docstatus asc, "tabSales Invoice".modified DESC limit 1
...
select name from "tabSales Order" where ifnull("tabSales Order".status, '') not in ('Completed', 'Closed') and ifnull("tabSales Order".docstatus, 0) < 2.0 and "tabSales Order".customer = '_Test Customer 1 - 1' order by "tabSales Order".docstatus asc, "tabSales Order".modified DESC limit 1
...
select name from "tabJob Applicant" where "tabJob Applicant".status = 'Open' order by "tabJob Applicant".modified desc limit 100
...
select name from "tabRequest for Quotation" where "tabRequest for Quotation".docstatus = 0.0 order by "tabRequest for Quotation".docstatus asc, "tabRequest for Quotation".modified DESC limit 100
...
select name from "tabPurchase Order" where "tabPurchase Order".status not in ('Completed', 'Closed') and "tabPurchase Order".docstatus < 2.0 order by "tabPurchase Order".docstatus asc, "tabPurchase Order".modified DESC limit 100
...
select exchange_rate from "tabCurrency Exchange" where ifnull("tabCurrency Exchange".date, '0000-00-00') <= '2016-01-15' and "tabCurrency Exchange".from_currency = 'USD' and "tabCurrency Exchange".to_currency = 'INR' order by date desc limit 1
...
select name from "tabcontact" where tabcontact.status = 'Open' order by tabcontact.modified desc limit 100
...
select name, owner, creation, data from "tabversion" where tabversion.docname = 'EV00013' and tabversion.ref_doctype = 'Event' order by creation desc limit 10
...
select *, timestamp(posting_date, posting_time) as "timestamp" from "tabStock Ledger Entry" where item_code = '_Test Item Home Desktop 100' and warehouse = '_Test Warehouse - _TC' and ifnull(is_cancelled, 'No')='No' and timestamp(posting_date, posting_time) > timestamp('2017-02-09', '12:26:28.301535') and name!='SLE/00000161' order by timestamp(posting_date, posting_time) asc, name asc
