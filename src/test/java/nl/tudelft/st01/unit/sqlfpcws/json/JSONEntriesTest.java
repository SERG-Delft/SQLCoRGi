...
public class JSONEntriesTest {
    ...
    /**
     * Assert that a newly created {@link JSONEntries} object returns an empty {@link ArrayList} of type {@link String}
    ...
    public void testGetEntriesAfterAddingOneEntry() {
        SQLRules rules = new SQLRules(1, new ArrayList<>());
    ...
    public void testGetEntriesAfterAddingMultipleEntries() {
        SQLRules rules1 = new SQLRules(1, new ArrayList<>());
        SQLRules rules2 = new SQLRules(2, new ArrayList<>());
        SQLRules rules3 = new SQLRules(3, new ArrayList<>());
